...
//        }
//        bool _disposed;
//        ClientState _state = ClientState.Closed;
...
//        #endregion
//        #region Constructor
//        public HttpClient() : this(new HttpServer(0), new TcpClient())
//        {
//        }
...
namespace PHttp
{
    internal class HttpClient : IDisposable
    {
        ...
        private void BeginRead()
        {
            ...
            {
                Console.WriteLine("BeginRead failed", ex);
        ...
        private void ReadCallback(IAsyncResult asyncResult)
        {
            ...
            {
                Console.WriteLine("Failed to read from the HTTP connection", ex);
        ...
        private void BeginWrite()
        {
            ...
            {
                Console.WriteLine("BeginWrite failed", ex);
        ...
        private void WriteCallback(IAsyncResult asyncResult)
        {
            ...
            {
                Console.WriteLine("Failed to write", ex);
        ...
        private void ProcessException(Exception exception)
        {
            ...
            try
            {
                ...
                {
                    string resources = ConfigurationManager.AppSettings["Resources"];
            ...
            {
                Console.WriteLine("Failed to process internal server error response", ex);
