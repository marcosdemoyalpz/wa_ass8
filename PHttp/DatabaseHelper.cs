            ...
            foreach (var app in _apps)
            {
                ...
                else
                {
                    ...
                    if (app.database == "URL_Shortener_App_DB.sqlite")
                    {
                        ...
                        // ### Add some data to the table
                        sql = "insert into urls (shortURL, longURL, username, dateCreated, clicks, lastClicked) values ('hello', 'https://www.google.com', 'admin', DATETIME('NOW'), 0, '0000-01-01 00:00:00' )";
                        command.CommandText = sql;
                        command.ExecuteNonQuery();
